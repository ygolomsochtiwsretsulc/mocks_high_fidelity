...
def get_ratio_z(ll_0, f_ll_0, redshift):
	...
	F_0 = quad(itp_0, ll_2.value, ll_05.value)[0]
	F_z2 = quad(itp_z2, ll_2.value, ll_05.value)[0]
	return F_0, F_z2
...
n.savetxt(
	os.path.join(os.environ['GIT_VS'], 'data', 'xray_k_correction', 'soft-2-soft-z.txt'),
	n.transpose([ 
		n.hstack(( ZZ )),
		n.hstack(( NH )),
		n.hstack(( RR ))
