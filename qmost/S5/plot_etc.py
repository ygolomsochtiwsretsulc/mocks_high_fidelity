...
# pathes for S5 on johan's laptop
root_dir = '/home/comparat/data/4most/S5/'
template_dir = '/home/comparat/data/4most/templates/'
path_2_template = lambda tpl_name : os.path.join(template_dir, tpl_name)
path_2_catalog = os.path.join( root_dir, 'S5_Clusters_May2nd_correct_output_ETC21_05_19_11-52-15.fits' )
output_folder = os.path.join( root_dir, 'etc_plots')
path_2_archive = os.path.join( root_dir, 'etc_plots_S5.tar.gz')

## pathes for S6 on johan's laptop
#root_dir = '/home/comparat/data/4most/S6/'
#template_dir = '/home/comparat/data/4most/templates/'
#path_2_template = lambda tpl_name : os.path.join(template_dir, tpl_name)
#path_2_catalog = os.path.join( root_dir, 'S6_summary_may2nd_correct_output_ETC21_05_19_11-52-43.fits' )
#output_folder = os.path.join( root_dir, 'etc_plots')
#path_2_archive = os.path.join( root_dir, 'etc_plots_S6.tar.gz')
