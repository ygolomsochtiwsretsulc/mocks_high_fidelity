...
# loads the catalog
data = fits.open(os.path.join(working_dir, 'S5_Clusters_latest_input_cat.fits.gz'))[1].data

#sub_1 = (data['ID_SUB_SURVEY']==1)
#sub_2 = (data['ID_SUB_SURVEY']==2)
#sub_3 = (data['ID_SUB_SURVEY']==3)
...
def create_LSM(sub_survey_name):
