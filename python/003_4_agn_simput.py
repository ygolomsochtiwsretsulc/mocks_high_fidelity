...
for HEALPIX_id in n.arange(N_pixels):
    ...
    data_z = n.round(
        n.hstack(
            (hd_all[1].data['redshift_R'][sel_all],
             hd_sat[1].data['redshift_R'][sel_sat])),
        1)
    ra_array = n.hstack(
        (hd_all[1].data['ra'][sel_all],
         hd_sat[1].data['ra'][sel_sat]))
    dec_array = n.hstack(
        (hd_all[1].data['dec'][sel_all],
         hd_sat[1].data['dec'][sel_sat]))
    ...
    FX_array = n.hstack(
        (hd_all[1].data['AGN_FX_soft'][sel_all],
         hd_sat[1].data['AGN_FX_soft'][sel_sat]))
