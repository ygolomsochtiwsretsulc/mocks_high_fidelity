...
python3 004_1_cluster_Merge.py environmentVAR 
...
#for baseName in baseNames:
    #print(baseName)
    #path_2_light_cone = os.path.join(fits_dir, baseName + '.fits')
    #path_2_coordinate_file = os.path.join(
        #fits_dir, baseName + '_coordinates.fits')
    #path_2_galaxy_file = os.path.join(fits_dir, baseName + '_galaxy.fits')
    #path_2_CLU_file = os.path.join(fits_dir, baseName + '_CLU.fits')
